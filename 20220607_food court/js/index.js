...
const showToday = () => {
    ...
    let day = now.getDay();
    const namesOfTheDayOfTheWeek_array = ['일', '월', '화', '수', '목', '금', '토'];
    //console.log(year, month, date, namesOfTheDayOfTheWeek_array[day]);

    //문자열 형식 맞추고
    let title = `${year}.${month}.${date}.(${namesOfTheDayOfTheWeek_array[day]})`;
    //console.log(title);
